Project Overview: dist_file_storage
...
Function	Purpose
CASPathTransformFunc(key)	SHA-1 hashes a key, splits into 5-char path segments (e.g., 71056/ad8aa/24742/...) to avoid filesystem limits
